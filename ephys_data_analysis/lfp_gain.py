...
period = False  # if False, the  frequency (over speed) is plotted instead of the period
recaluculate = False
...
if recaluculate:
    ...
    if period:
        period_over_speed_plot_info = {'speeds_real05': s_real05, 'speeds_real15': s_real15,
        ...
        hickle.dump(period_over_speed_plot_info, path+'hickle/Summary/period_over_speed_plot_info.hkl', mode='w')
    else:
        freq_over_speed_plot_info = {'speeds_real05': s_real05, 'speeds_real15': s_real15,
                                     'speeds_vir05': s_vir05, 'speeds_vir15': s_vir15,
                                     'lfp05': lfp_05, 'lfp15': lfp_15,
                                     'x05': X05, 'mean05': M05, 'std05': S05, 'n05': N05, 'Perc25_05': P25_05,
                                     'Perc75_05': P75_05, 'Median05': Median05,
                                     'x15': X15, 'mean15': M15, 'std15': S15, 'n15': N15, 'Perc25_15': P25_15,
                                     'Perc75_15': P75_15, 'Median15': Median15,
        ...
        print 'saving hickle under: '+path+'hickle/Summary/freq_over_speed_plot_info.hkl'
        hickle.dump(freq_over_speed_plot_info, path+'hickle/Summary/freq_over_speed_plot_info.hkl', mode='w')

# Here data is loaded _________________________________________________________________________________________

else:
    dic = hickle.load(path+'hickle/Summary/freq_over_speed_plot_info.hkl')

    speeds_real05 = dic['speeds_real05'][0]
    speeds_real15 = dic['speeds_real15'][0]
    speeds_vir05 = dic['speeds_vir05'][0]
    speeds_vir15 = dic['speeds_vir15'][0]
    if period:
        lfp05 = dic['period05'][0]
        lfp15 = dic['period15'][0]
    else:
        lfp05 = dic['lfp05'][0]
        lfp15 = dic['lfp15'][0]
    x05 = dic['x05'][0]
    ...
    x05v = dic['x05v'][0]
    x15v = dic['x15v'][0]
    median05 = dic['Median05'][0]
    median15 = dic['Median15'][0]
    median05v = dic['Median05v'][0]
    median15v = dic['Median15v'][0]
    perc25_05 = dic['Perc25_05'][0]
    perc25_15 = dic['Perc25_15'][0]
    perc75_05 = dic['Perc75_05'][0]
    perc75_15 = dic['Perc75_15'][0]
    perc25_05v = dic['Perc25_05v'][0]
    perc25_15v = dic['Perc25_15v'][0]
    perc75_05v = dic['Perc75_05v'][0]
    perc75_15v = dic['Perc75_15v'][0]

# Here data is plotted ________________________________________________________________________________________

c_05 = custom_plot.pretty_colors_set2[0]
c_15 = custom_plot.pretty_colors_set2[1]

fig, ax = pl.subplots(1, 1, figsize=(10, 7))
fig1, ax1 = pl.subplots(1, 1, figsize=(10, 7))
...
fig.legend((cl1_line, cl2_line), ("Gain = 0.5", "Gain = 1.5"), numpoints=1, loc="best", fontsize=15, frameon=False)
fig1.legend((cl1_line, cl2_line), ("Gain = 0.5", "Gain = 1.5"), numpoints=1, loc="best", fontsize=15, frameon=False)

print 'average gain 0.5 speed in treadmill coordinates: ', numpy.average(speeds_real05)
print 'average gain 1.5 speed in treadmill coordinates: ', numpy.average(speeds_real15)
ax.scatter(speeds_real15, lfp15, facecolors=c_15, edgecolors='none', linewidth='1')
ax.scatter(speeds_real05, lfp05, facecolors=c_05, edgecolors='none', linewidth='1')
...
if not x05 == []:
    ...
    ax.plot(x05, median05, color='#024b30', lw=2)
    ax.fill_between(x05, perc25_05, perc75_05, color='#024b30', alpha=0.5)
    ...
    if period:
        ...
        print 'Saving figure under: /Users/haasolivia/Desktop/freq_over_speed_median.pdf'
        fig.savefig('/Users/haasolivia/Desktop/freq_over_speed_median.pdf', format='pdf')


ax1.scatter(speeds_vir15, lfp15, facecolors=c_15, edgecolors='none', linewidth='1')
ax1.scatter(speeds_vir05, lfp05, facecolors=c_05, edgecolors='none', linewidth='1')
...
if not x05v == []:
    ...
    ax1.plot(x05v, median05v, color='#024b30', lw=2)
    ax1.fill_between(x05v, perc25_05v, perc75_05v, color='#024b30', alpha=0.5)
    ...
    if period:
        ...
        print 'Saving figure under: /Users/haasolivia/Desktop/freq_over_speed_virtual_median.pdf'
        fig1.savefig('/Users/haasolivia/Desktop/freq_over_speed_virtual_median.pdf', format='pdf')
